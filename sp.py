...
def aper(image,xc,yc,phpadu,apr,skyrad,badpix,prnt=False, silent=False, flux=False, exact = False, nan = False, setskyval = [], readnoise = [], meanback = False, clipsig=3., maxiter=5.,converge_num=0.02, minsky = 20.):
...
INPUTS:
 ...
 OPTIONAL INPUTS:
     ...
     prnt -- if set and non-zero then APER will also write its results to
	       ...
	       setting PRNT = 'filename'. (default = False) [not functional]
